...
class Fin_Seance extends Component {
  ...
  submitActivites = async () => {
    ...
    const submittedActivites = {sport, douleurAvant, douleurApres, zoneDouleurAvant, zoneDouleurApres, nbKilometre, duree, userId}; //ajouter nbrKm et duree
